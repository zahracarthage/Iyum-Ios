...
/** If we didn't receive any new location for `unconditionalStatusPollingPatienceSeconds` seconds we will start poll `getStatus` unconditionally. Default is 2.0. */
