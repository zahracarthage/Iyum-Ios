...
#import <MapboxNavigationNative/MBNNOpenLROrientation.h>
#import <MapboxNavigationNative/MBNNOpenLRSideOfRoad.h>
...
- (MBNNOpenLRSideOfRoad)getSideOfRoad;
/** Specifies orientation */
- (MBNNOpenLROrientation)getOrientation;
